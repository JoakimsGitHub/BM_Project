  ...
  section.innerHTML = `
    <div class="carousel-content">
      ...
      <div class="carousel">
        ...
        <button class="carousel-button carousel-prev"><span class="arrow"><</span></button>
        <button class="carousel-button carousel-next"><span class="arrow">></span></button>
      </div>
    </div>
  `;
...
async function createTopGamesSection() {
  ...
  // Creating the string of URL (query) parameters using the URLSearchParams object is more reliable than string concatenation.
...
allGameCards.forEach(game => {
  ...
  section.querySelectorAll('.signup-button').forEach(btn => {
    btn.addEventListener('click', (e) => {
        e.stopPropagation(); // Preventing event from bubbling up.
        window.location.href = 'sign-up.html';
    });
});

section.querySelectorAll('.read-more-button').forEach(btn => {
    btn.addEventListener('click', (e) => {
        e.stopPropagation(); 
